...
if(isset($_POST['update'])){
    ...
    $updatedData = mysqli_query($config,"UPDATE accountant_detail SET admNo='$admNo',frtn='$frtn' ,lstn='$lstn',gen='$gen',dobe='$dobe',blgp='$blgp',
    regin='$regin',mail='$mail',teapass='$teapass',adres='$adres',ponh='$ponh',facd='$facd',insd='$insd',twitd='$twitd',mesae='$mesae',
    uspoto='$orgFileName' WHERE id='$id'");
    if($updatedData){
