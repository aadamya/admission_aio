...
if (isset($_POST['submit'])) {
    ...
    $insertdData = mysqli_query($config, "INSERT INTO notice_board(title, details, assigned_role, posted_by, dinak) VALUES ('$Tital', '$Details', '$Assigned_role', '$Posted_by', '$Date')");
